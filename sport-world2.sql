...
VALUES ('La Liga'),('Bundesliga'),('Premier League'),('Seria A'),('League 1'),('EfBet League');
...
VALUES ('STANDARD'),('ADMIN'),('MODERATOR'),('BANNED');
...
INSERT INTO users
	(username, password_hash, email, phone_number, salt, role_id)
VALUES
	("Preslav", "34c0918b8e6e9f12ca2a8ecfd213011b29cfe9d2601bb870c20f51fc2a3ea946", "paf_st@gmail.com",
	 "0876634000", "VeqzfePhXlKNOLZ+ENromHTJLvs=", 2);
...
-- Dump completed on 2022-06-18 15:09:59

...
public class MailService {
    private static String DOMAIN = "sandbox4db94ae521554f1ebbde171d382b13be.mailgun.org";

//    public static void main(String[] args) {
//        sendMail("hello world", "hello world", "preslav0609@gmail.com");
//
//    }
    ...
    public void sendMail(String subject, String body, String recipients) {
        try {
            ...
            form.add(new BasicNameValuePair("from", "Sport-World <admin@sport-world.com>"));
    ...
    private static CredentialsProvider getAuthProvider() {
        ...
        UsernamePasswordCredentials credentials
                = new UsernamePasswordCredentials("api", "pubkey-3114c8da0cdcbe6446832b6160291fd0");
